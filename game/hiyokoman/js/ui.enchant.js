...
var pad = "images/pad/pad.png";
var apad = "images/pad/apad.png";
var icon0 = "images/pad/icon0.png";
var font0 = "images/pad/font0.png";

/**
 * @type {Object}
 */
enchant.ui = { assets: [pad, apad, icon0, font0] };
...
enchant.ui.MutableText = enchant.Class.create(enchant.Sprite, {
    ...
    setText: function(txt) {
        ...
        for (i = 0; i < txt.length; i++) {
            ...
            this.image.draw(enchant.Game.instance.assets[font0],
...
enchant.ui.LifeLabel = enchant.Class.create(enchant.Group, {
    ...
    initialize: function(x, y, maxlife) {
        ...
        for (var i = 0; i < this._maxlife; i++) {
            ...
            this.heart[i].image = enchant.Game.instance.assets[icon0];
