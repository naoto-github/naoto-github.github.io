...
(function() {
	...
	var start = "images/nineleap/start.png";
	var end = "images/nineleap/end.png";	

    /**
     * @type {Object}
     */
    enchant.nineleap = { assets: [start, end] };
    ...
    enchant.nineleap.Core = enchant.Class.create(enchant.Core, {
        ...
        initialize: function(width, height) {
            ...
            this.addEventListener('load', function() {
                ...
                this.startScene.image = this.assets[start];
                ...
                //this.endScene.image = this.assets[end];
